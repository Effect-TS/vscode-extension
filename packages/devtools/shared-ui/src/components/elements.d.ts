...
type WebComponentProps<I extends HTMLElement> =
  ...
  namespace JSX {
    interface IntrinsicElements {
      ...
      "vscode-icon": WebComponentProps<VscodeIcon> & {
        "onvsc-click"?: CustomEventHandler<CustomEvent<{ originalEvent: MouseEvent }>>
      }
      ...
      "vscode-tree": WebComponentProps<VscodeTree> & {
        "onvsc-tree-select"?: CustomEventHandler<CustomEvent<Array<VscodeTreeItem>>>
      }
