...
import { Event, Span } from "@/SpanRoots/Span"
...
function TraceAttributes({
  ...
  return attributes.length === 0 ? (
    ...
    <AccordionItem value="attributes" className="mb-2 border-b-0">
      <AccordionTrigger className="py-0 pl-2 justify-start bg-transparent data-[state=open]:mb-1 cursor-pointer !no-underline">
...
function TraceEvents({ events }: { readonly events: ReadonlyArray<Event> }) {
  return events.length === 0 ? (
    ...
    <AccordionItem value="events" className="border-b-0">
      <AccordionTrigger className="py-1 pl-2 justify-start bg-[--sl-color-bg-nav] cursor-pointer !no-underline">
...
function TraceEvent({ node }: { readonly node: Event }) {
  ...
  return (
    <Fragment>
      <AccordionTrigger className="group bg-[--sl-color-bg] p-0 justify-start data-[state=open]:mb-1 cursor-pointer !no-underline">
